...
export const metadata = {
  title: 'E-Aduan UiTM',
  description:
    'Ada aduan? Salurkan aduan anda mengikut kategori yang sesuai di bawah.',
};
    ...
    <div className="lp-auth-root">
      ...
      <nav className="lp-nav">
        <div className="lp-nav-inner">
          ...
          <div className="lp-nav-links">
            <Link href="/" className="lp-nav-link lp-nav-active" id="nav-home">
              Anjung
            </Link>
          ...
          <div className="lp-nav-end">
            {session ? (
              ...
              <Link href="/login" className="lp-login-btn" id="login-button">
                Log Masuk
              </Link>
            )}
          </div>
      ...
      <section className="lp-hero">
        ...
        <div className="lp-hero-text">
          ...
          <p className="lp-hero-subtitle">
            Ada aduan? Salurkan aduan anda mengikut kategori yang sesuai di
            bawah:
          </p>
        </div>
      </section>
      ...
      <main className="lp-body">
        ...
        <div className="lp-cards-row">
          ...
          >
            ...
            <div className="lp-card-hover-overlay">
              <span className="lp-card-hover-text">
          ...
          >
            ...
            <div className="lp-card-hover-overlay">
              <span className="lp-card-hover-text">
                Sebarang masalah berkenaan dengan WIFI, internet, sistem
          ...
          <Link
            href={getAduanLink('/aduan/fasiliti')}
            className="lp-card"
            id="card-fasiliti"
          >
            <div className="lp-card-top">
            ...
            <div className="lp-card-hover-overlay">
              <span className="lp-card-hover-text">
                Sebarang kerosakan elektrikal, landskap, pengurusan majlis,
                sivil dan telekomunikasi
              </span>
            </div>
          </Link>
        </div>
        ...
        <div className="lp-qa-row">
          ...
          <Link href="/panduan" className="lp-qa-btn" id="btn-manual">
            Manual Aduan Umum
          </Link>
          <Link href="/faq" className="lp-qa-btn" id="btn-faq">
            Soalan Lazim
          </Link>
        </div>
        ...
        <section className="lp-help" id="help">
          ...
          <p className="lp-help-desc">
            Jika anda berada dalam situasi kecemasan, berikut adalah talian
            penting yang boleh dihubungi:
          </p>
          ...
          <div className="lp-help-cols">
            <div className="lp-help-col">
              ...
              <ul className="lp-help-ul">
                <li>
                  <strong>Dalam kampus UiTM:</strong>
                  <br />
                  03-5544 3999 (Keselamatan UiTM)
                </li>
                <li>
                  <strong>Luar kampus:</strong>
                  <br />
                  999 (Polis / Ambulan / Bomba)
                </li>
              </ul>
            </div>
            ...
            <div className="lp-help-col">
              ...
              <ul className="lp-help-ul">
                <li>
                  <strong>Ambulan UiTM (Kampus Shah Alam):</strong>
                  <br />
                  03-5544 2999
                </li>
                <li>
                  <strong>Klinik Kesihatan UiTM:</strong>
                  <br />
                  03-5544 2200
                </li>
                <li>
                  <strong>Hospital berdekatan:</strong>
                  <br />
                  Sila hadir ke hospital berhampiran untuk rawatan segera.
                </li>
              </ul>
            </div>

            <div className="lp-help-col">
              <h3 className="lp-help-col-title">
                Lain-Lain Perkhidmatan Kecemasan UiTM
              </h3>
              <ul className="lp-help-ul">
                <li>
                  <strong>Pejabat Bendahari UiTM (Kecemasan Kewangan):</strong>
                  <br />
                  03-5544 2626
                </li>
                <li>
                  <strong>Talian Umum UiTM (General Line):</strong>
                  <br />
                  03-5544 2000
                </li>
              </ul>
