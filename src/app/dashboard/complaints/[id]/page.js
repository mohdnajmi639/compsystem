  ...
  useEffect(() => {
    ...
    if (role === 'admin' || role === 'staff')
      fetch('/api/users')
        ...
        .then((d) =>
          setStaffList(
            Array.isArray(d) ? d.filter((u) => u.role === 'staff') : [],
          ),
        )
        .catch(() => {});
  }, [id, role]);
            ...
            <div style={{ display: 'flex', gap: '8px' }}>
                      ...
                      <button
                        onClick={() => {
                          if (!complaint.assignedTo) {
                            showToast(
                              'Sila ambil aduan ini terlebih dahulu sebelum memulakan proses.',
                              'error',
                            );
                            return;
                          }
              ...
              {role === 'staff' &&
                ...
                complaint.status === 'Pending' && (
                  <button
                    onClick={() =>
                      updateComplaint({ assignedTo: session.user.id })
                    }
          ...
          >
                  ...
                  {attachments.some(isImage) && (
                    <div
                      style={{
                        ...
                        gap: '12px',
                        marginBottom: attachments.some((a) => !isImage(a))
                          ? '16px'
                          : 0,
                      }}
                    >
            ...
            <div className="card" style={{ padding: 0, overflow: 'hidden' }}>
              ...
              >
                ...
                >
                  Aktiviti & Respons ({complaint.responses?.length || 0})
                </h3>
              </div>
              ...
              <div style={{ padding: '24px' }}>
                {complaint.responses?.length > 0 ? (
                  ...
                  >
                    ...
                    >
                      Tiada respons direkodkan setakat ini.
                    </p>
                  </div>
                )}
                  ...
                  complaint.status !== 'Rejected' && (
                    ...
                    >
                      ...
                      <textarea
                        ...
                        placeholder="Taip respons anda di sini..."
              ...
              <div className="card" style={{ padding: 0, overflow: 'hidden' }}>
                ...
                <div style={{ padding: '24px' }}>
                  ...
                  {complaint.feedbackComment ? (
                    ...
                    >
                      Tiada komen tambahan diberikan.
                    </p>
                  )}
                </div>
              </div>
              ...
              >
                <div>
                  ...
                  {complaint.submittedBy?.studentId && (
                    ...
                    >
                      No. Pelajar: {complaint.submittedBy.studentId}
                    </div>
                  )}
                  {complaint.submittedBy?.department && (
                    ...
                    >
                      {formatDepartment(complaint.submittedBy.department)}
                    </div>
                  )}
                </div>
                ...
                <div>
                  ...
                  {complaint.assignedTo ? (
                    <>
                      ...
                      <div style={{ color: '#6b7280', fontSize: '0.8rem' }}>
                        {formatDepartment(complaint.assignedTo.department)}
                      </div>
                    </>
                  ) : (
                    <div
                ...
                <div>
                  ...
                  <div style={{ color: '#374151', fontSize: '0.85rem' }}>
                    {new Date(complaint.createdAt).toLocaleString('ms-MY')}
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div style={{ color: '#374151', fontSize: '0.85rem' }}>
                    {new Date(complaint.updatedAt).toLocaleString('ms-MY')}
                  </div>
                </div>
                ...
                {attachments.length > 0 && (
                  <>
                    ...
                    <div>
                      ...
                      >
                        {attachments.length} fail dilampirkan
                      </div>
                    </div>
                  </>
                )}
          ...
          >
            ...
            >
              ...
              <form onSubmit={handleResolveSubmit} style={{ padding: '24px' }}>
                ...
                >
                  Keterangan / Tindakan Penyelesaian
                </label>
                <textarea
                  className="form-textarea"
