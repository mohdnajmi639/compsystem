...
export const metadata = {
  ...
  description:
    'Soalan Lazim (FAQ) berkaitan Sistem e-Aduan UiTM — jawapan kepada soalan-soalan yang kerap ditanya.',
};
...
const faqItems = [
  {
    ...
    jawapan: (
      <p>
        Sistem e-Aduan UiTM merupakan saluran aduan rasmi yang merekodkan dan
        memberi maklum balas aduan daripada warga UiTM dan juga orang awam.
      </p>
    ),
  },
  {
    ...
    jawapan: (
      <p>
        Untuk menggunakan Sistem e-Aduan UiTM, pengguna perlu log masuk dengan
        akaun Google (GMail) melalui menu log masuk. Selepas itu, pengguna boleh
        terus mengisi butiran aduan di borang &ldquo;Aduan Baru&rdquo;.
      </p>
    ),
  },
  {
    id: 3,
    soalan:
      'Apakah kategori aduan yang boleh diadukan kepada Sistem e-Aduan UiTM?',
    jawapan: (
      <>
      ...
      <>
        ...
        <ul>
          <li>
            ...
            <p>
              Pastikan perkara yang ingin diadukan adalah berkaitan dengan
              perkhidmatan, fasiliti, staf, atau isu berkaitan tatakelola
              universiti.
            </p>
          </li>
          <li>
          ...
          <li>
            ...
            <ul>
              ...
              <li>
                Jabatan / Fakulti / Kampus Cawangan Berkenaan (sekiranya pegadu
                memilih &lsquo;Tidak Pasti&rsquo;, aduan akan dihantar ke
                Pejabat Komunikasi Strategik untuk diproses)
              </li>
            </ul>
          </li>
          <li>
            ...
            <ul>
              ...
              <li>
                Lampiran bukti (jika ada &ndash; gambar, tangkap layar, dokumen)
              </li>
            </ul>
          </li>
          <li>
            ...
            <ul>
              ...
              <li>
                Elakkan tuduhan tanpa bukti, kata kesat, atau maklumat palsu.
              </li>
            </ul>
          </li>
          <li>
            ...
            <ul>
              <li>
                Log masuk semula ke Sistem e-Aduan UiTM untuk melihat status
                terkini.
              </li>
              <li>
                Aduan akan diuruskan secara berperingkat dan tertakluk kepada
                prosedur dalaman universiti.
              </li>
            </ul>
          </li>
        </ul>
  ...
  },
  {
    ...
    jawapan: (
      <p>
        Tempoh maklum balas aduan adalah dalam masa 15 hari bekerja mengikut
        Pekeliling AM Bilangan 2 Tahun 2022 : Penambahbaikan Pengurusan Aduan
        Awam bagi Aduan Biasa. Manakala aduan kategori kompleks adalah sehingga
        365 hari. Penentuan aduan kategori biasa dan kompleks adalah berdasarkan
        kepada butiran kes yang diterima.
      </p>
    ),
  },
  {
    id: 6,
    soalan:
      'Dalam situasi kecemasan, adakah terdapat nombor telefon Polis Bantuan UiTM yang boleh dihubungi?',
    jawapan: (
      <p>
        Ya, berikut adalah senarai nombor telefon Polis Bantuan yang boleh
        dihubungi 24 jam bagi sebarang kecemasan atau pertanyaan.
      </p>
    ),
  },
];
...
const emergencyContacts = [
  ...
  {
    negeri: '',
    kampus: 'SG. BULOH, SELAYANG, T.INTAN',
    telefon: '03-61267474',
  },
  ...
  {
    negeri: 'ILD UiTM',
    kampus: 'BANDAR ENSTEK, N. SEMBILAN',
    telefon: '06-7580267',
  },
  ...
  return (
    <div className="lp-auth-root">
      ...
      <nav className="lp-nav">
        <div className="lp-nav-inner">
          ...
          <div className="lp-nav-links">
            <Link href="/" className="lp-nav-link" id="faq-nav-anjung">
              Anjung
            </Link>
            <NavDropdownAduan />
            {session?.user?.role !== 'admin' &&
              session?.user?.role !== 'staff' && <NavDropdownSemak />}
            <Link href="/panduan" className="lp-nav-link" id="faq-nav-panduan">
              Panduan
            </Link>
            <Link
              href="/faq"
              className="lp-nav-link lp-nav-active"
              id="faq-nav-faq"
            >
              Soalan Lazim
            </Link>
      ...
      <main className="faq-main">
        <div
          className="faq-container glass-panel"
        ...
        >
          ...
          <div className="faq-table-section">
            <h2 className="faq-table-title">
              MAKLUMAT NOMBOR TELEFON KECEMASAN 24 JAM
              <br />
              POLIS BANTUAN
              <br />
              ...
              <table className="faq-table">
                ...
                <tbody>
                  {emergencyContacts.map((row, idx) => (
                    <tr
                      key={idx}
                      className={idx % 2 === 0 ? 'faq-tr-even' : 'faq-tr-odd'}
                    >
                      <td>{row.negeri}</td>
                      <td>{row.kampus}</td>
                      <td>{row.telefon}</td>
