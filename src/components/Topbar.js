...
export default function Topbar() {
  ...
  if (displayDept === 'ICT')
    displayDept = 'Teknologi Maklumat dan Komunikasi (ICT)';

  const roleLabel =
    role === 'admin' ? 'Pentadbir' : role === 'staff' ? displayDept : role;
    ...
    <header className="db-topbar">
      ...
      <div className="db-topbar-right">
        ...
        >
          ...
          {unread > 0 && (
            <span className="db-topbar-notif-badge">
              {unread > 9 ? '9+' : unread}
            </span>
          )}
        </Link>
        ...
        <div className="db-topbar-user-wrap">
          ...
          >
            ...
            <div className="db-topbar-user-text">
              <span className="db-topbar-user-name">
