...
function AduanFasilitiContent() {
  ...
  const handleHantar = async (e) => {
    e.preventDefault();
    if (!lokasiPilih) {
      setError('Sila pilih lokasi kerosakan.');
      return;
    }
    if (!jenisBangunan) {
      setError('Sila pilih jenis lokasi (Dalam Bangunan / Luar Bangunan).');
      return;
    }
    ...
    if (negeri.startsWith('--') || negeri === '-- Sila Pilih --') {
      setError('Sila pilih Negeri.');
      return;
    }

    if (!ket.trim()) {
      setError('Sila isi keterangan lokasi.');
      return;
    }
    if (!ketKerosakan.trim()) {
      setError('Sila isi keterangan kerosakan.');
      return;
    }
  ...
  const isJasmine =
    typeof currentBangunan === 'string' &&
    currentBangunan.startsWith('Jasmine');
  ...
  if (isJasmine) {
    ...
    isBlokAkademik &&
    (dbBlok === 'Blok Akademik' || dbBlok === '--Sila Pilih--')
  ) {
    if (dbAras === 'Aras 1') {
      activeRuangOpts = [
        '--Sila Pilih--',
        ...
        'Bilik Elektrik',
        'Bilik Fail',
        'Bilik Gerakan Peperiksaan',
        'Bilik ICT',
        'Bilik Janitor',
        'Bilik Juru Teknik',
        'Bilik Kebal',
        'Bilik Kerja Akaun',
        'Bilik Kerja Akauntan Kanan',
        'Bilik Kuliah',
        'Bilik Mesyuarat',
        'Bilik PABX',
        'Bilik Pegawai',
        ...
        'Bilik Wudhu',
        'HR',
        'Info. Mgmt. (I.M) Lounge',
        'Kafeteria',
        'Kaunter',
        'Ketua Pusat Pengajian',
        'Ketua Pustakawan',
        'Ketua Unit Kualiti',
        'Koleksi Akses Terhad',
        'Koordinator Program',
        'Koridor Awam',
        'Laluan Lif',
        'Makmal Komputer',
  ...
  if (seksyen === 'MAJ - AUDIO VISUAL') {
    ...
    activeElemenOpts = [
      '--Sila Pilih--',
      'ETIKA PEKERJA KONTRAKTOR',
      'PENGURUSAN PROJEK',
      'PERSEKITARAN TAPAK BINA',
    ];
  ...
  if (elemen === 'PEST CONTROL') {
    ...
    activeMasalahOpts = [
      '--Sila Pilih--',
      'LAIN-LAIN ADUAN SANITARY BIN',
      'SANITACT BERBAU',
      'SANITACT TIDAK DIPUNGUT',
      'SANITACT TIDAK TERURUS',
    ];
  } else if (elemen === 'CCTV') {
    activeMasalahOpts = [
      '--Sila Pilih--',
      'CCTV TIADA BERGAMBAR',
      'CCTV TIDAK MEREKOD DATA',
      'LAIN-LAIN ADUAN KEROSAKAN CCTV',
    ];
  } else if (seksyen === 'MAJ - AUDIO VISUAL') {
    if (elemen === 'SISTEM VISUAL') {
      activeMasalahOpts = [
        '--Sila Pilih--',
        'KUALITI TON WARNA VISUAL MULTIMEDIA BERUBAH',
        'LAIN-LAIN KEROSAKKAN SISTEM AUDIO VISUAL',
        'PAPARAN VISUAL MULTIMEDIA TIDAK SEKATA',
        'SKRIN KOYAK',
        'SKRIN MULTIMEDIA TIADA ISYARAT VISUAL',
        'SKRIN TERJATUH',
        'SKRIN TIDAK BOLEH DINAIKKAN/DITURUNKAN',
      ];
    } else if (elemen === 'SISTEM AUDIO') {
      activeMasalahOpts = [
        '--Sila Pilih--',
        'LAIN-LAIN KEROSAKAN SISTEM AUDIO',
        'SISTEM AUDIO ROSAK',
      ];
    } else if (elemen === 'SISTEM PENCAHAYAAN PENTAS') {
      activeMasalahOpts = [
        '--Sila Pilih--',
        'DMX SPLITTER TIDAK BERFUNGSI / ROSAK',
        'LAIN-LAIN KEROSAKKAN SISTEM PENCAHAYAAN PENTAS',
        'LAMPU PENTAS ROSAK',
        'LAMPU PENTAS TIDAK MENYALA',
        'LIGHTING CONSOLE ROSAK',
      ];
    }
  } else if (seksyen === 'BAN - BANGUNAN') {
    if (elemen === 'KEROSAKAN BANGUNAN') {
      activeMasalahOpts = [
        '--Sila Pilih--',
        'BINGKAI TINGKAP REPUT',
        'BLIND/LANGSIR ROSAK',
        'BUMBUNG BOCOR',
        'BUMBUNG TERCABUT',
        'CAT SILING KOTOR',
        'DINDING KOTOR/BERCONTENG',
        'DINDING RETAK',
        'JUBIN TERTANGGAL/TERKOPEK',
        'KACA TINGKAP PECAH',
        'KAYU LANTAI PARKET DIMAKAN ANAI-ANAI',
        'LAIN-LAIN KEROSAKAN BANGUNAN',
        'LAMINAT DINDING ROSAK/MENGELUPAS',
        'LANTAI BERLUBANG/PECAH',
        'RAILING BESI TANGGA REPUT',
        'SELAK TUAS TINGKAP PATAH/ROSAK',
        'SILING (KESAN RESAPAN AIR)',
        'SILING BERLUBANG',
        'SILING BOCOR',
        'SILING ROSAK/PECAH',
        'SILING RUNTUH',
        'SILING TIDAK DIPASANG',
        'SIMEN SKRID TANGGA PECAH',
        'TINGKAP KETAT',
        'TINTED FIRL ROSAK/TERCABUT',
      ];
    } else if (elemen === 'KEROSAKAN PINTU') {
      activeMasalahOpts = [
        '--Sila Pilih--',
        'ANAK KUNCI PATAH',
        'DOOR CLOSER ROSAK/TAK BERFUNGSI',
        'HANDLE PINTU PATAH/ROSAK',
        'JENANG/BINGKAI PINTU ROSAK',
        'KUNCI PINTU ROSAK',
        'KUNCI/TOMBOL BERKARAT',
        'LAIN-LAIN KEROSAKAN PINTU',
        'PINTU DIMAKAN ANAI-ANAI',
        'PINTU KETAT',
        'PINTU PECAH',
        'PINTU TERJATUH',
        'PINTU TERKUNCI',
      ...
      activeMasalahOpts = [
        '--Sila Pilih--',
        'BASIN BASUH TANGAN BOCOR',
        'BASIN BASUH TANGAN PECAH',
        'BASIN BASUH TANGAN TERSUMBAT',
        'BESI PENYANGKUT PAKAIAN TERCABUT',
        'BOTTLE TRAP ROSAK/BOCOR',
        'CERMIN TANDAS PECAH/ROSAK',
        'FLUSH VALVE ROSAK',
        'FLUSHING HANDLE TAK BERFUNGSI/ROSAK',
        'KEPALA PAIP BOCOR',
        'KEPALA PAIP LONGGAR',
        'LAIN-LAIN KEROSAKAN PERALATAN PLUMBING',
        'MANGKUK TANDAS PECAH/ROSAK',
        'PAIP TANDAS BOCOR',
        'PELAPIK TANDAS DUDUK TIADA',
        'PENDAKAP PAIP PATAH/TERCABUT',
        'SALURAN PERANGKAP LANTAI TERSUMBAT',
        'SALURAN TANDAS TERSUMBAT/TERSEKAT',
        'SHOWER HEAD ROSAK',
        'TANGKI PENYIMBAH PECAH',
        'TANGKI TANDAS BOCOR/MELIMPAH',
        'TIADA BEKALAN AIR DI TANDAS',
        'TIADA SABUN',
        'TIADA TISU TANDAS',
      ];
      ...
      activeMasalahOpts = [
        ...
        'BANGUNAN KOTOR',
        'KARPET BERBAU/KOTOR',
        'LAIN-LAIN ADUAN KEBERSIHAN BANGUNAN',
        'LANTAI KOTOR',
        'PAPAN PUTIH TIDAK DIBERSIHKAN',
        'PERABOT/PERALATAN BERHABUK',
        'SAMPAH TIDAK DIPUNGUT',
        'SILING/DINDING BERSAWANG',
        'TANDAS BERBAU BUSUK',
        'TANDAS KOTOR',
      ];
    }
    ...
    if (elemen === 'BEKALAN ELEKTRIK') {
      activeMasalahOpts = [
        '--Sila Pilih--',
        'BEKALAN ELEKTRIK TERPUTUS SATU ARAS',
        'BEKALAN ELEKTRIK TERPUTUS SATU BANGUNAN',
        'BEKALAN ELEKTRIK TERPUTUS SATU BILIK',
        'BEKALAN ELEKTRIK TERPUTUS SATU KAMPUS',
        'LAIN-LAIN ADUAN BEKALAN ELEKTRIK',
      ];
    } else if (elemen === 'PEPASANGAN ELEKTRIK') {
      activeMasalahOpts = [
        '--Sila Pilih--',
        'KIPAS ANGIN ROSAK',
        'KIPAS ANGIN TERTANGGAL',
        'KOTAK PAPAN AGIHAN (DB) PECAH',
        'LAIN-LAIN ADUAN PEPASANGAN ELEKTRIK',
        'PINTU PAPAN AGIHAN (DB) TERTANGGAL',
        'SOKET SUIS PECAH',
        'SOKET SUIS TERBAKAR',
        'SOKET SUIS TERTANGGAL',
        'SOKET SUIS TIADA BEKALAN',
        'SUIS PECAH',
        'SUIS TERTANGGAL',
        'WAYAR/KABEL/TRUNKING ELEKTRIK TERJUNTAI',
        'WAYAR/KABEL/TRUNKING ELEKTRIK TERPUTUS',
        'WAYAR/KABEL/TRUNKING TERBAKAR',
      ];
    } else if (elemen === 'LAMPU DALAM BANGUNAN') {
      activeMasalahOpts = [
        '--Sila Pilih--',
        'LAIN-LAIN ADUAN LAMPU DALAM BANGUNAN',
      ...
      activeMasalahOpts = [
        '--Sila Pilih--',
        'LAIN-LAIN ADUAN LAMPU LUAR BANGUNAN',
        'LAMPU BERKELIP',
        'LAMPU JALAN TIDAK BERNYALA',
        'LAMPU MALAP',
        'LAMPU TANDA KELUAR (EXIT SIGN) ROSAK',
        'PENUTUP LAMPU JALAN TERBUKA',
        'TIANG BESI TERDAPAT ARUS ELEKTRIK',
        'TIANG LAMPU JALAN PATAH/BENGKOK',
        'WAYAR LAMPU JALAN TERKELUAR',
      ];
    }
  } else if (seksyen === 'INF CIV - INFRASTRUKTUR') {
    if (elemen === 'INFRASTRUKTUR') {
      activeMasalahOpts = [
        '--Sila Pilih--',
        'PEMBAHAGI JALAN ROSAK/PECAH',
        'BAHU JALAN / KERB ROSAK ATAU TANGGAL',
        'BATU INTERLOCKING MENDAP',
        'CAT JALAN / PARKIR PUDAR',
        'DINDING / TEMBOK PENAHAN PECAH',
        'GRATING LONGKANG PUTUS',
        'JALAN/PARKIR BERLUBANG',
        'JALAN/PARKIR MENDAP',
        'LAIN-LAIN ADUAN KEROSAKAN INFRASTRUKTUR',
        'LONGKANG PECAH',
        'PAGAR / PINTU PAGAR ROSAK',
        'PAGOLA ROSAK',
        'PEMBENTUNG PAIP PECAH',
        'PENUTUP LONGKANG HILAN/ROSAK',
        'SAMBUNGAN SUSUR TANGGA PUTUS',
        'SUSUR ANAK TANGGA ROSAK',
        'TANAH / CERUN RUNTUH',
        'WAKAF ROSAK',
      ];
    }
    ...
    if (elemen === 'PERKHIDMATAN LANSKAP') {
      activeMasalahOpts = [
        ...
        'AIR TERJUN TIDAK BERFUNGSI',
        'BUNGKUSAN SAMPAH DAUN TIDAK DIPUNGUT',
        'DAHAN POKOK MELEMPAI KE STRUKTUR',
        'DAHAN POKOK PATAH',
        'JALAN BERPASIR/BERMINYAK',
        'JALANRAYA/PARKING KENDERAAN TIDAK DISAPU',
        'KEMUDAHAN AWAM (PERHENTIAN BAS, KERUSI & MEJA TAMAN, WAKAF, PAPANTADA DAN BBQ PIT)',
        'KOLAM/TASIK TIDAK DIBERSIHKAN',
        'LAIN-LAIN ADUAN LANSKAP',
        'LALUAN PEJALAN KAKI, DATARAN TIDAK DIBERSIHKAN',
        'LONGKANG TIDAK DIBERSIHKAN',
        'PAGAR TIDAK DIBERSIHKAN',
        'POKOK MATI / LAYU',
        'POKOK TUMBANG',
        'RUMPUT PANJANG/TIDAK DIPOTONG',
        'SAMPAH LUAR BANGUNAN BERSEPAH',
        'SCUPPER DRAIN TERSUMBAT/SAMPAH TIDAK DIBERSIHKAN',
        'TONG SAMPAH KAWASAN LUAR BANGUNAN MELIMPAH',
      ];
    } else if (elemen === 'PUNGUTAN SAMPAH') {
      activeMasalahOpts = [
        '--Sila Pilih--',
        'DRAIN SUMP RUMAH SAMPAH KOTOR/TIDAK DICUCI/TERSUMBAT',
        'KAWASAN TIDAK DISELENGGARA',
        'LAIN-LAIN ADUAN SAMPAH LUAR BANGUNAN',
        'RUMAH SAMPAH TIDAK DICUCI/DIBERSIHKAN',
        'SAMPAH DI RUMAH SAMPAH TIDAK DIKUTIP',
        'SAMPAH SISA BINAAN/PALLET/POLYSTYREN YANG TERBIAR MELEBIHI DARI 1 MINGGU',
        'SAMPAH TIDAK DIPUNGUT',
      ];
    } else if (elemen === 'POKOK BUNGA BERPASU') {
      activeMasalahOpts = [
        '--Sila Pilih--',
        'AIR SIRAMAN MELIMPAH',
        'DAHAN MELEMPAI KE STRUKTUR/JALANRAYA',
        'DAHAN PATAH DI LAIN-LAIN TEMPAT/KAWASAN',
        'DAHAN POKOK PATAH MENGHALANG JALAN UTAMA',
        'DAHANPATAH TERKENA BANGUNAN/STRUKTUR',
        'LAIN-LAIN ADUAN POKOK BUNGA BERPASU',
        'PASU PECAH',
        'POKOK BUNGA TIDAK DISELENGGARA',
        'POKOK MATI/LAYU',
        'POKOK TIDAK DISELENGGARA',
        'POKOK TUMBANG DI LAIN-LAIN TEMPAT/KAWASAN',
        'POKOK TUMBANG MENGHALANG JALAN UTAMA',
        'POKOK TUMBANG TERKENA BANGUNAN/STRUKTUR',
      ];
    }
  } else if (seksyen === 'MEC - MEKANIKAL') {
    if (elemen === 'LIFT') {
      activeMasalahOpts = [
        '--Sila Pilih--',
        'BUTTON LIF ROSAK',
        'KIPAS LIF TIDAK BERFUNGSI',
        'LAIN-LAIN ADUAN KEROSAKAN LIF',
        'LAMPU LIF TIDAK MENYALA',
        'LIF TERGENDALA/PENUMPANG TERPERANGKAP',
        'LIF TIDAK BERFUNGSI',
      ];
    } else if (elemen === 'MESIN AIR SEJUK/PANAS') {
      activeMasalahOpts = [
        '--Sila Pilih--',
        'FRONT COVER MESIN AIR SEJUK TERTANGGAL',
        'LAIN-LAIN ADUAN KEROSAKAN MESIN AIR SEJUK',
        'MESIN AIR SEJUK TERSUMBAT',
        'MESIN AIR SEJUK/PANAS TAK BERFUNGSI',
        'PAIP BEKALAN MESIN AIR SEJUK PATAH',
        'PENAPIS BEKALAN MESIN AIR KOTOR',
      ];
    } else if (elemen === 'PENYAMAN UDARA') {
      activeMasalahOpts = [
        '--Sila Pilih--',
        'AIR MENITIK DARI PENYAMAN UDARA',
        'BUNYI BISING PADA PENYAMAN UDARA',
        'LAIN-LAIN ADUAN KEROSAKAN PENYAMAN UDARA',
        'PENYAMAN UDARA BERBAU BUSUK',
        'PENYAMAN UDARA ROSAK',
        'PENYAMAN UDARA TIDAK BERFUNGSI',
        'PENYAMAN UDARA TIDAK SEJUK',
        'STARTER PENYAMAN UDARA ROSAK',
      ];
    } else if (elemen === 'PENCEGAH KEBAKARAN') {
      activeMasalahOpts = [
        '--Sila Pilih--',
        'KABINET PANEL PENGGERA KAWALAN ROSAK',
        'LAIN-LAIN ADUAN KEROSAKAN PENCEGAH KEBAKARAN',
        'LOCENG KECEMASAN PENCEGAH KEBAKARAN BERBUNYI',
        'PANEL PENGGERA KEBAKARAN TIADA BEKALAN KUASA',
        'PILI BOMBA BOCOR',
        'TANGKI ARI PENCEGAH KEBAKARAN (MERAH) BOCOR/OVERFLOW',
      ];
    } else if (
      elemen === 'ROLLER SHUTTER/GATE AUTOMATIK' ||
      elemen === 'ROLLE SHUTTER/GATE AUTOMATIK'
    ) {
      activeMasalahOpts = [
        '--Sila Pilih--',
        'LAIN-LAIN KEROSAKAN ROLLER SHUTTER/GATE AUTOMATIK',
        'PINTU PAGAR AUTOMATIK ROSAK',
        'ROLLER SHUTTER TIDAK BERFUNGSI',
      ];
    } else if (elemen === 'PEMADAM API') {
      activeMasalahOpts = [
        '--Sila Pilih--',
        'GATE VALVE HOSE REEL PEMADAM API HILANG',
        'HOSE REEL PEMADAM API ROSAK',
        'KABINET HOSE REEL ROSAK',
        'LAIN-LAIN ADUAN KEROSAKAN PEMADAM API',
        'NOZZLE PEMADAM API PATAH',
        'PEMADAM API TIDAK BERFUNGSI',
        'VALVE PEMANDAM API BOCOR',
      ];
    } else if (elemen === 'MESIN PERAKAM WAKTU') {
      activeMasalahOpts = [
        '--Sila Pilih--',
        'CETAKAN MESIN PERAKAM TIDAK JELAS',
        'KAD TERSEKAT DIDALAM MESIN PERAKAM',
        'LAIN-LAIN ADUAN KEROSAKAN MESIN PERAKAM WAKTU',
        'MASA PADA MESIN PERAKAM TIDAK TEPAT',
        'MELODI MESIN PERAKAM TIDAK BERFUNGSI',
        'MESIN PERAKAM TIDAK BERFUNGSI',
      ];
    } else if (elemen === 'LIQUID PETROLEUM GAS') {
      activeMasalahOpts = [
        '--Sila Pilih--',
        'LAIN-LAIN ADUAN KEROSAKAN LIQUID PETROLEUM GAS',
        'LIQUID PETROLEUM BERBAU GAS',
        'PAIP LIQUID PETROLEUM GAS BOCOR',
      ];
    } else if (elemen === 'BEKALAN AIR') {
      activeMasalahOpts = [
        '--Sila Pilih--',
        'LAIN-LAIN ADUAN KEROSAKAN BEKALAN AIR',
        'PAIP BEKALAN AIR PECAH',
        'PAIP BEKALAN BOCOR',
        'PAM KOLAM RENANG ROSAK',
        'TANGKI AIR MELIMPAH',
      ...
      activeMasalahOpts = [
        '--Sila Pilih--',
        'AIR NAJIS OVERFLOW (MANHOLE)',
        'LAIN-LAIN ADUAN KEROSAKAN KUMBAHAN',
        'PEMBENTUNG PAIP PECAH',
      ];
    }
  } else if (seksyen === 'PROJEK - PROJEK') {
    if (elemen === 'ETIKA PEKERJA KONTRAKTOR') {
      activeMasalahOpts = [
        '--Sila Pilih--',
        'BERSIKAP KURANG AJAR/BIADAP',
        'KELAKUAN TIDAK SENONOH',
        'LAIN-LAIN ADUAN ETIKA PEKERJA KONTRAKTOR',
      ...
      activeMasalahOpts = [
        '--Sila Pilih--',
        'KEROSAKAN DI DALAM TANGGUNGAN KECACATAN',
        'LAIN-LAIN ADUAN PENGURUSAN PROJEK',
        'TIADA KOMUNIKASI DENGAN PELANGGAN',
        'TIADA PENYELIA TAPAK',
      ];
    } else if (elemen === 'PERSEKITARAN TAPAK BINA') {
      activeMasalahOpts = [
        '--Sila Pilih--',
        'BERBAU BUSUK DI TAPAK PEMBINAAN',
        'KEADAAN BERSEPAH DI TAPAK PEMBINAAN',
        'KEADAAN MERBAHAYA DI TAPAK PEMBINAAN',
        'LAIN-LAIN ADUAN PERSEKITARAN KERJA TAPAK PEMBINAAN',
        'LEBIHAN BINAAN TIDAK DIBERSIHKAN',
        'PERSEKITARAAN TAPAK BINAAN BERBUNYI BISING',
      ];
    }
  } else if (seksyen === 'TEL - TELEKOMUNIKASI') {
    if (elemen === 'WALKIE_TALKIE') {
      activeMasalahOpts = [
        '--Sila Pilih--',
        'LAIN-LAIN ADUAN KEROSAKAN WALKIE TALKIE',
        'WALKIE_TALKIE BERBUNYI BISING',
        'WALKIE_TALKIE TIADA BUNYI',
      ];
    } else if (elemen === 'TELEFON') {
      activeMasalahOpts = [
        '--Sila Pilih--',
        'BUTANG TELEFON ROSAK',
        'GANGGANG TELEFON ROSAK',
        'LAIN-LAIN ADUAN KEROSAKAN TELEFON',
        'LINE FAX TIDAK BERFUNGSI',
        'SOKET TELEFON ROSAK',
        'TELEFON TIADA DERINGAN',
        'TELEFON TIDAK BERFUNGSI',
        'TELEFON TIDAK BOLEH MENERIMA PANGGILAN',
        'TELEFON TIDAK DAPAT MEMBUAT PANGGILAN',
      ];
    } else if (elemen === 'DOOR ACCESS') {
      activeMasalahOpts = [
        '--Sila Pilih--',
        'DOOR ACCESS TIDAK BERFUNGSI',
        'EM LOCK DOOR ACCESS TANGGAL',
        'LAIN-LAIN ADUAN KEROSAKAN DOOR ACCESS',
        'READER DOOR ACCESS PECAH / TERTANGGAL',
      ];
    } else if (elemen === 'PENDAWAIAN') {
      activeMasalahOpts = [
        '--Sila Pilih--',
        'LAIN-LAIN KEROSAKAN PENDAWAIAN',
        'TAMATAN KABEL TELEFON PADA SERVICE BOX LANTAI TIDAK SEMPURNA',
      ];
    } else if (elemen === 'BARRIER PARKING') {
      activeMasalahOpts = [
        '--Sila Pilih--',
        'BARRIER PARKING TIDAK BERFUNGSI',
        'LAIN-LAIN ADUAN KEROSAKAN BARRIER PARKING',
      ];
    }
  }
        ...
        <main className="aduan-body">
          <div className="aduan-success-box">
            ...
            <p className="aduan-success-text">
              ...
              dalam masa 3–5 hari bekerja. Anda boleh menyemak status aduan di
              halaman Semakan.
            </p>
            <div className="aduan-success-actions">
              <button
                ...
                onClick={handleReset}
                id="fasiliti-aduan-baharu"
              >
                Hantar Aduan Baharu
              </button>
              <Link
                href="/aduan/fasiliti/semak"
                className="aduan-cancel-btn"
                id="fasiliti-semak-link"
              >
                Semak Status Aduan
              </Link>
            </div>
      ...
      <main className="aduan-body">
        ...
        <div className="aduan-page-header">
          <div className="aduan-page-header-inner">
            ...
            <p className="aduan-page-desc">
              Sistem Pengurusan Aduan dan Perkhidmatan Pejabat Pengurusan
              Fasiliti
            </p>
          </div>
        </div>
        ...
        <div className="aduan-form-wrap">
                  ...
                  <div className="aduan-field-grid aduan-field-grid-2">
                    ...
                    >
                      ...
                      <div className="aduan-field">
                        ...
                        <div className="aduan-value-box">
                          B04 - Kampus Puncak Perdana
                        </div>
                      </div>

                      <div className="aduan-field">
                        <label className="aduan-label">
                          Bangunan <span className="aduan-required">*</span>
                        </label>
                        <select
                          className="aduan-input aduan-select"
                          value={
                            jenisBangunan === 'dalam' ? dbBangunan : lbBangunan
                          }
                          onChange={(e) => {
                      ...
                      {showBlok && (
                        <div className="aduan-field">
                          <label className="aduan-label">
                            Blok <span className="aduan-required">*</span>
                          </label>
                          <select
                            className="aduan-input aduan-select"
                            value={jenisBangunan === 'dalam' ? dbBlok : lbBlok}
                            onChange={(e) => {
                              if (jenisBangunan === 'dalam') {
                        ...
                        dbBlok !== 'Sub Station 1' && (
                          <div className="aduan-field">
                            ...
                            <select
                              className="aduan-input aduan-select"
                              value={dbRuang}
                              onChange={(e) => setDbRuang(e.target.value)}
                            >
                              {activeRuangOpts.map((o) => (
                                <option key={o} value={o}>
                                  {o}
                                </option>
                              ))}
                        ...
                        <>
                          ...
                          <div className="aduan-field">
                            ...
                            <select
                              className="aduan-input aduan-select"
                              value={lbSubInfra}
                              onChange={(e) => setLbSubInfra(e.target.value)}
                            >
                              {activeSubInfraOpts.map((o) => (
                                <option key={o} value={o}>
                                  {o}
                                </option>
                              ))}
                      ...
                      <div className="aduan-field">
                        ...
                        <textarea
                          ...
                          onChange={(e) =>
                            jenisBangunan === 'dalam'
                              ? setDbKeterangan(e.target.value)
                              : setLbKeterangan(e.target.value)
                          }
                        />
                      </div>
                    </div>
                    ...
                    >
                      ...
                      <div className="aduan-field">
                        <label className="aduan-label">
                          Seksyen <span className="aduan-required">*</span>
                        </label>
                        <select
                          className="aduan-input aduan-select"
                          value={seksyen}
                      ...
                      <div className="aduan-field">
                        <label className="aduan-label">
                          Elemen <span className="aduan-required">*</span>
                        </label>
                        <select
                          className="aduan-input aduan-select"
                          value={elemen}
                      ...
                      <div className="aduan-field">
                        <label className="aduan-label">
                          Masalah <span className="aduan-required">*</span>
                        </label>
                        <select
                          className="aduan-input aduan-select"
                          value={masalah}
                      ...
                      <div className="aduan-field">
                        <label className="aduan-label">
                          ...
                          <div className="aduan-field-hint">
                            (Sila isikan keterangan terperinci, cth no.telefon){' '}
                            <span className="aduan-required">*</span>
                          </div>
                        </label>
                        <textarea
          ...
          <div className="aduan-disclaimer">
            <strong>Penafian:</strong> Saya mengaku bahawa segala maklumat aduan
            yang dikemukakan adalah benar dan saya bertanggungjawab ke atas
            aduan tersebut. Sistem ini disediakan untuk pengurusan aduan rasmi
            UiTM. Semua data yang dikemukakan adalah sulit dan hanya untuk
            kegunaan dalaman universiti.
          </div>
        </div>
      </main>
      ...
      <div className="lp-nav-inner">
        ...
        <div className="lp-nav-end">
          {session ? (
            ...
            <Link
              href="/login?callbackUrl=/aduan/fasiliti"
